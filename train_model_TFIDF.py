...
from text_cnn_model import TextCNN_TFIDF_Weighted as TextCNN
...
tf.flags.DEFINE_string("gpu_id", 0, "id of gpu")
...
vectorizer = TfidfVectorizer(max_df=1.0, min_df=1, max_features=20000)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        savePath = FLAGS.train_data_path + '.cnn.tf'
